...
export const MODULES = {
  ...
  dashboard: {
    ...
    price: null,
    status: "available",
    note: "Финансовая аналитика за 30/90 дней («Админка → Аналитика») — выдано заказов, выручка, средний чек. Раньше был платным модулем в группе «Аналитика» — теперь входит в базовый пакет всем клиентам без доплаты.",
  },
  ...
  receipt_ocr: {
    ...
    price: 20000,
    status: "available",
    note: "Автопроверка чеков через Google Vision. Тариф для клиента: $2 за 1000 чеков. Накопленный расход — вкладка «Расход» в настройках и карточка клиента в панели оператора (сброс после оплаты).",
  },
  telegram_stars: {
  ...
  smart_search: {
    ...
    price: 16000,
    status: "available",
    note: "Фолбэк, когда обычный поиск ничего не нашёл — подбор по смыслу через LLM. У каждого запроса реальная стоимость (Anthropic API): в админке вкладка «Расход» (накоплено с последнего сброса), в панели оператора счётчик можно обнулить после оплаты. Дневной лимит и cooldown остаются предохранителем от накрутки.",
  },
  web_storefront: {
