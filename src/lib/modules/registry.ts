...
export const MODULES = {
  ...
  order_status: {
    ...
    price: null,
    status: "planned",
    note: "В прайсе значится как входящее в базу, но кнопки статуса заказа в боте нет. Либо реализовать, либо убрать из прайса.",
  },
  excel_export: {
    ...
    price: null,
    status: "planned",
    note: "В прайсе значится как входящее в базу, но выгрузки заказов/клиентов в коде нет. Либо реализовать, либо убрать из прайса.",
  },
  legal_docs: {
  ...
  courses: {
    ...
    price: 18000,
    status: "planned",
    note: "ВНИМАНИЕ: у Анастасии в bots.modules стоит courses=true, но кода курсов в репозитории нет. Проверить, что именно ей продано.",
  },
