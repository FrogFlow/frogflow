...
export async function notifyConsultantHandoff(params: {
  ...
  try {
    ...
    const reasonLabels: Record<string, string> = {
      ...
      photo_sent: "📸 Прислал фото — бот его не видит, диалог передан вам",
      voice: "🎤 Голосовое сообщение — бот его не слышит",
      wholesale: "📦 Оптовый запрос — условий у бота нет, диалог передан вам",
      long_dialogue: "💬 Длинный разговор — бот передал диалог вам, чтобы не ошибиться",
      error: "⚠️ Ошибка",
