...
/**
 * Страна по умолчанию, пока покупатель не сказал иного.
 *
 * Раньше страну спрашивали шлагбаумом: на «Какая стоимость полотенец Uchino?»
 * бот отвечал «Подскажите, из какой вы страны обращаетесь?» — и разговор
 * затухал, не начавшись. Продавец: пусть просто называет цену в тенге, а если
 * человек из России, он попросит в рублях, и тогда переведём.
 *
 * Магазин в Алматы, прайс ведётся в тенге — поэтому умолчание KZ. Слова
 * «Россия», «в рублях» и российские города переключают страну в любой момент
 * разговора: matchCountry смотрит текущее сообщение раньше сохранённого
 * состояния.
 */
export const DEFAULT_CONSULTANT_COUNTRY: ConsultantCountry = "KZ";
