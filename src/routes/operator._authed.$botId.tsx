...
import { ReceiptAuditSection } from "@/lib/operator/receipt-audit-section";
 ...
 *
 * Группа, которой здесь нет, получает от indexOf −1 и уезжает в самое начало,
 * впереди «Базы» — поэтому новый раздел реестра надо добавлять и сюда.
 */
const GROUP_ORDER = [
  "База",
  "Оплата",
    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        <TabsList className="flex h-auto flex-wrap justify-start gap-1">
          ...
          <TabsTrigger value="receipts">Проверка чеков</TabsTrigger>
