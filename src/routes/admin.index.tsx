    ...
    <div className="space-y-6">
      ...
      <div className="bg-card border rounded-lg p-4">
        ...
        <ol className="list-decimal pl-5 text-sm space-y-1 text-muted-foreground">
          ...
          <li>
            При выключенной Robokassa: проверьте скриншот и нажмите «Подтвердить». При включённой — для RU/KZ чек может
            выдать файлы сразу (уведомление без кнопки); остальные страны — через Robokassa.
          </li>
        </ol>
      </div>
    </div>
