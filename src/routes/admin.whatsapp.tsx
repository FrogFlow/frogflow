      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            />
            <p className="text-xs text-muted-foreground">
              Через запятую. Совпадение по целому сообщению: «Каталог» бота позовёт, «а где ваш
              каталог?» — нет. Этими же словами открывается магазин у нового покупателя: команды
              /start в WhatsApp нет.
            </p>
          </div>
        </CardContent>
      </Card>
