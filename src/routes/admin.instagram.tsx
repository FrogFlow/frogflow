...
function StoriesTab({ accountId }: { accountId?: string }) {
  ...
  if (!accountId) return <div>�������� ������� �� ������� "��������"</div>;
  if (storiesQuery.isLoading) return <div>�������� �������...</div>;
  ...
  return (
    <div className="border rounded-lg overflow-hidden flex flex-col">
      {thumbnailUrl ? (
        ...
        <div className="w-full h-48 bg-muted flex items-center justify-center text-xs text-muted-foreground">��� ������</div>
      )}
      <div className="p-3 flex flex-col gap-3">
        <div>
          <Label className="text-xs mb-1 block">�������� ������</Label>
          <Input value={name} onChange={e => setName(e.target.value)} placeholder="��������� 70x140" className="h-8 text-sm" />
        </div>
        <div>
          <Label className="text-xs mb-1 block">���� (?)</Label>
